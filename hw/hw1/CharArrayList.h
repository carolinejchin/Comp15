...
class CharArrayList {
    ...
    private:
        ...
        * list, and the current size of the array in memory */
        char *data;
        int  len, cap; //len = how many elementsare in the arraylist
                       //cap = how many elements the arraylist can hold
        void expand(); //expands capacity of ArrayList when len==cap
};
